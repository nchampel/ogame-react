...
const Nature = (props) => {
  ...
  const validationSchemaQuestions = Yup.object().shape({
  ...
  const validationSchemaChoiceBGZ = Yup.object().shape({
  ...
  const question3Data = [
    ...
    {
      value: "em",
      label: "Vous l'arrêtez, vous ne savez pas garder un secret",
    },
    ...
    {
      value: "sb",
      label: "Vous l'écoutez en sachant que cela vous laissera de marbre",
    },
    {
      value: "sm",
      label: "Vous l'interrompez et lui parlez d'un de vos secrets à la place",
    },
  ];
  const question4Data = [
    {
      value: "rb",
      label: "Vous gardez la tête haute, mais vous êtes détruit intérieurement",
    },
    { value: "rm", label: "Vous l'insultez de tous les noms" },
    { value: "eb", label: "Vous vous serez la main bons amis" },
    {
      value: "em",
      label: "Vous n'osez prononcer un mot de peur de tout perdre",
    },
    ...
    {
      value: "am",
      label: "Vous refusez la situation et vous vous enfermez dans votre bulle",
    },
    {
      value: "sb",
      label:
    ...
    {
      value: "sm",
      label: "Vous ne réagissez pas et attendez la suite des événements",
    },
  ];
  ...
  return (
    ...
    <>
      <Box sx={{ minHeight: "600px" }}>
          ...
          <DialogContent>
            <Formik
              ...
              onSubmit={async (
                ...
                try {
                  // console.log(values)
                  const nature = await userApi.determineNature(
                    values,
                  ...
                  >
                    ...
                    {activeStep === 1 && (
                      <FormControl>
                        ...
                        >
                          Vous êtes en retard pour un rendez-vous. En cherchant
                    ...
                    {activeStep === 2 && (
                      <FormControl>
                        <Typography sx={{ textAlign: "center", fontSize: 18 }}>
                          Votre ami veut vous confier un lourd secret le
                          concernant.
                        </Typography>
                        <RadioGroup
                          // row
                    ...
                    {activeStep === 3 && (
                      <FormControl>
                        <Typography sx={{ textAlign: "center", fontSize: 18 }}>
                          Votre moitié veut rompre avec vous.
                        </Typography>
                  ...
                  <Box sx={{ display: "flex", justifyContent: "center" }}>
                    <Autocomplete
                      ...
                      getOptionLabel={(option) =>
                        `${names[option]} : ${descriptions[option]}`
                      }
                      options={choices}
                      onChange={(_, value) => {
                        setFieldValue("choice", value !== null ? value : null);
                      }}
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          ...
                          InputLabelProps={{
                            style: { color: isFocused ? "#1976d2" : "white" },
                            shrink: true,
                          }}
        ...
        <Typography>
          Répondez aux questions pour déterminer votre alignement Benguelzen
          (BGZ)
        </Typography>
